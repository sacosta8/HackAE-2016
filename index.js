...
db.serialize(function() {
  //db.run("CREATE TABLE InfoAndDescription (name TEXT, address TEXT, details TEXT)");
});
...
app.post('/locations', urlencodedParser, function (req, res) {
  ...
  console.log(req.body.fname);
  db.serialize(function() {
    db.run("INSERT into InfoAndDescription VALUES (\""+req.body.name+"\",\""+req.body.address+"\",\""+req.body.details+"\")");
